...
from hybernet.backbone import HybridNetsBackbone
...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='/media/usman/Lab/erfnet/cityscapes',
    ...
    parser.add_argument("--model", type=str, default='TNet',
...
#==========================================================================================================
    ...
    # model = HybridNetsBackbone(seg_classes=19)
